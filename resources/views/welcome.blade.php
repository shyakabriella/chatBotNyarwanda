...
<div>
    <div class="container-fluid m-0 d-flex p-2">
        ...
        <img width="100%" height="100%" style="border-radius:50px;" src="https://icon-library.com/images/avatar-icon-images/avatar-icon-images-4.jpg" alt="">
        </div>
...
<script>
   ...
   $.ajax({
    ...
    success: function(data){
        ...
        `+data+` <hr> <div style="color:red;">AI Nyarwanda Made by Shyaka</div>
    </div>
    </div>`)
    $value = $('#input').val('');
